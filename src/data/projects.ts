...
`Browser (React)
    ...
    technologies: ['React', 'TypeScript', 'Node.js', 'Express', 'WebSockets', 'RabbitMQ', 'MongoDB', 'Web Crypto API', 'Google OAuth'],
    featured: true,
    links: {
      github: 'https://github.com/Nikhil-Gautam-dev/encora',
      live: 'https://your-encora-url.vercel.app', // ← Replace with actual URL
    },
  },
  {
    ...
    technologies: ['Node.js', 'TypeScript', 'MongoDB', 'CSFLE', 'AWS KMS', 'Azure Key Vault', 'GCP KMS', 'Jest'],
    featured: true,
    links: {
  ...
  },
  {
    ...
    technologies: ['React', 'TypeScript', 'Node.js', 'Express', 'MongoDB', 'JWT', 'mirage-encryption', 'Vite', 'TailwindCSS'],
    featured: true,
    links: {
      github: 'https://github.com/Nikhil-Gautam-dev/TodoCrypt',
      live: 'https://todocrypt.vercel.app',
    },
  },
  {
    title: 'Nikki',
...
`                   SQLite
    ...
    technologies: ['Node.js', 'TypeScript', 'SQLite', 'Commander.js', 'systemd', 'tsup', 'chrono-node'],
    featured: true,
    links: {
      github: 'https://github.com/Nikhil-Gautam-dev/nikki',
      live: 'https://www.npmjs.com/package/nikki-cli',
    },
  },
  {
    ...
    technologies: ['React', 'Redux Toolkit', 'JavaScript', 'Vite', 'CSS Modules'],
    featured: true,
    links: {
      github: 'https://github.com/Nikhil-Gautam-dev/Memory-Match-Mania',
      live: 'https://your-memory-match-url.vercel.app', // ← Replace with actual URL
    },
  },
];
